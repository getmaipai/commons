...
// `useBreakpoint` (the kit's own phone/tablet cutoff, under 720px) reads
// `window.innerWidth` directly and updates on a `resize` listener, not
// `matchMedia` - the stub here is harmless but no longer load-bearing for
// this hook.
