 ...
 * so anything measuring that shell's `clientHeight` (an app's own top-anchor
 * scroll math among them) thinks the keyboard-covered strip at the bottom is
 * still visible. Only `window.visualViewport.height` reports the height
